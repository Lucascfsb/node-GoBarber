...
class FakeAppointmentsRepository {
  ...
  async findAllInDayFromProvider({
    ...
    const appointments = this.appointments.filter(appointment => {
      return appointment.provider_id === provider_id && (0, _dateFns.getMonth)(appointment.date) + 1 === month && (0, _dateFns.getYear)(appointment.date) === year && (0, _dateFns.getDate)(appointment.date) === day;
    });
    return appointments;
  }
  async create({
...
var _default = exports.default = FakeAppointmentsRepository;